...
class SimpleTest(unittest.TestCase):
    ...
    # def debug():
    #     return 'debug'
    def goToCollectionPage(self):
        nameOfPage = 'https://dev.nft.mobilelab.vn/account/Haii/'
        self.driver.get(nameOfPage)
    def selectCollectedTab(self):
        pass
    def selectItem(self):
        exist = False
        # item not exist
